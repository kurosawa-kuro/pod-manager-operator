リファクタリング案を拝見しました。CPU負荷関連の部分を削除し、手順が整理され、よりシンプルで理解しやすくなっています。以下はその修正案に基づいた最終的な内容です。
...
これで、負荷関連の部分は削除され、チュートリアルはよりシンプルでわかりやすくなりました。受講生が混乱しないように、負荷監視に関する誤解を排除しました。